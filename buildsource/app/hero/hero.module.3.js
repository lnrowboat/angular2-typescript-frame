System.register(['@angular/core', '@angular/common', '@angular/forms', './hero.component.3', './hero-detail.component', './hero-list.component', './highlight.directive', './hero-routing.module.3', './jseditor.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, forms_1, hero_component_3_1, hero_detail_component_1, hero_list_component_1, highlight_directive_1, hero_routing_module_3_1, jseditor_component_1;
    var HeroModule;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (jseditor_component_1_1) {
                jseditor_component_1 = jseditor_component_1_1;
            }],
        execute: function() {
            HeroModule = (function () {
                function HeroModule() {
                ...
                HeroModule = __decorate([
                    core_1.NgModule({
                        ...
                        declarations: [
                            ...
                            highlight_directive_1.HighlightDirective, jseditor_component_1.TinyEditorComponent
                        ]
                    }), 
